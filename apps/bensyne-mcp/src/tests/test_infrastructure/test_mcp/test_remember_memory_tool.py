...
- Handler delegates to RememberMemoryUseCase
...
class TestRememberMemorySchema:
    ...
    def test_schema_in_all_tool_schemas(self) -> None:
        ...
        from src.infrastructure.mcp.schemas import ALL_TOOL_SCHEMAS, REMEMBER_SCHEMA
...
class TestRememberMemoryHandler:
    ...
    def test_handler_delegates_to_remember_memory_use_case(self, router: MemoryBankRouter) -> None:
        """handle_remember should still delegate to RememberMemoryUseCase."""
