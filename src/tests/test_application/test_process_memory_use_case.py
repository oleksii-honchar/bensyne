"""Unit tests for ProcessMemoryUseCase."""
...
class TestProcessMemoryUseCase:
    """Test ProcessMemoryUseCase orchestration logic."""
    ...
    @pytest.fixture
    def use_case(self, memory_repository, hash_index_service, logger) -> ProcessMemoryUseCase:
        return ProcessMemoryUseCase(
