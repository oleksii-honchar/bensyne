...
see_also:
  - "systems/bensyne-mcp/adrs/0001-namespace-registration-tool.adr.md"
  - "systems/racochu/adrs/0011-namespace-registration-on-startup.adr.md"
  - "adrs/0003-in-memory-namespace-registry.adr.md"
---

# ADR-SYS-0001: Memory Bank Registration Protocol
...
- See `systems/bensyne-mcp/adrs/0001-namespace-registration-tool.adr.md` for the server-side ADR.
...
- See `systems/racochu/adrs/0011-namespace-registration-on-startup.adr.md` for the client-side ADR.
...
>
> **2026-08-16:** Merged from bensyne-mcp ADR-0001 and racochu ADR-0011 into this protocol-level shared ADR.
