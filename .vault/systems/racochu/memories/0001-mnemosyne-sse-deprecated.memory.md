...
> **2026-08-16:** Merged into shared MEM-SYS-0001 (`../../memories/0001-mcp-transport-sse-deprecated.memory.md`) — the cross-system protocol-level memory; this node remains the racochu system-specific record.
