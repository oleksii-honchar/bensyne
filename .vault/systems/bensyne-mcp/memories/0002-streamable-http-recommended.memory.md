...
tags: [transport, mcp]
see_also: ["memories/0001-sse-transport-deprecated.memory.md", "../../memories/0002-mcp-transport-streamable-http.memory.md"]
---
...
> **2026-08-16:** Merged into shared MEM-SYS-0002 (`../../memories/0002-mcp-transport-streamable-http.memory.md`) — the cross-system protocol-level memory; this node remains the bensyne-mcp system-specific record.
