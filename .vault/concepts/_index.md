...
- [[0005-source-type-file-role]] — Source type taxonomy (agent-session/obsidian/per-repo-vault) and file role classification (config/code/docs)
...
- [[0007-file-metadata-layer]] — Architecture overview: 3-tier structure (domain/infrastructure/application), SQLite per-bank, FTS5, MCP tools
