...
supersedes: []
superseded_by: []
see_also: [concepts/0016-chunking-strategy-pattern.concept.md, decisions/0027-mastra-rag-integration.decision.md, decisions/0035-obsidian-note-chunking-strategy.decision.md]
---

# DEC-0034: Custom Chunking Strategies Framework

## Context

After integrating Mastra RAG (DEC-0027), all files were chunked uniformly based on file extension. Agent session files require special handling: frontmatter extraction as a separate chunk, session metadata enrichment from parent `session.md`, and session-scoped retrieval. A generic content-aware strategy cannot accommodate these source-specific behaviors.
