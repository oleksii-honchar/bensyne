...
supersedes: []
superseded_by: []
see_also: [decisions/0037-continue-on-forget-failure.decision.md, concepts/0014-file-memory-tracking.concept.md, concepts/0012-processing-model.concept.md]
deprecated:
  date: null
  reason: null
  superseded_by: null
...
# DEC-0036: Forget After Ingest on File Update
...
**Evidence:**
- DEC-0028 explicitly states: "When files are deleted or updated in watched directories, we need to update or delete corresponding memories in Mnemosyne"
...
| Don't forget old memories | Simple | Violates DEC-0028, memory bloat | Long-term reliability |
