...
No impact. With ~10^6 files, the birthday bound probability is still ~10^-30. The design decision to ignore collisions (DEC-0039) is sound and doesn't require mitigation.
