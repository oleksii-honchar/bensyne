...
see_also: [memories/0008-mnemosyne-sse-deprecated.memory.md, memories/0011-mcp-proxy-transport-switch.memory.md, memories/0002-mcp-transport-streamable-http.memory.md]
---
...
> **2026-08-16:** Merged into shared MEM-0002 (`../../memories/0002-mcp-transport-streamable-http.memory.md`) — the cross-system protocol-level memory; this node remains the racochu system-specific record.
