...
tags: [transport, mcp]
see_also: [memories/0004-streamable-http-recommended.memory.md, memories/0001-mcp-transport-sse-deprecated.memory.md]
---
...
> **2026-08-16:** Merged into shared MEM-0001 (`../../memories/0001-mcp-transport-sse-deprecated.memory.md`) — the cross-system protocol-level memory; this node remains the bensyne-mcp system-specific record.
