...
2. **Vault lookup** — For architecture, ADRs, concepts: check `.vault/` before asking
...
- [ ] Checked `.vault/` for relevant architecture before making design decisions
...
- `.vault/` — Architecture, ADRs, concepts, runbooks, specs. Read when you need architectural context.
